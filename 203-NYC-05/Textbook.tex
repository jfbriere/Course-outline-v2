...
\item Your teacher will tell you which {\bf one of the two textbooks} will be used in your section and whether you need an access code or not for the online homework system.
	...
	\end{itemize}
	The custom packages are available at the bookstore an include a semester-long access code for the online homework system. Used textbook generally do not include an access code.
